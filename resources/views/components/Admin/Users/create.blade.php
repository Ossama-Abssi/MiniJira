    ...
    <form action="{{route('user.store')}}" method="post">
        ...
        <div class="d-flex w-100">
            ...
            <div class="form-grouptext-center" style="width:48%">
                ...
                <input type="text" name="nom" class="input form-control w-100" id="nom" placeholder="Enter nom .">
            </div>
            <br>
            <div class="form-group" style="width:48%;margin-left:4%">
                <label class="label" for="prenom">prenom : </label><br>
                <input type="text" name="prenom" class="input form-control" id="prenom" placeholder="Enter prenom .">
            </div>
        </div>
        <br>
        <div class="form-group">
            <label class="label" for="About">About : </label><br>
            <input type="text" name="About" class="input form-control" style="min-height:100px;" id="About" placeholder="Enter About .">
        </div>
        <br>
        <div class="d-flex w-100">
            ...
            <div class="form-group" style="width:48%;">
                ...
                <input type="number" name="Age" class="input form-control" id="Age" placeholder="Enter Age .">
            </div>
            <br>
            <div class="form-group" style="width:48%;margin-left:4%">
                <label for="photo">photo : </label><br>
                <input class="form-control" type="file" name="photo" class="form-control-file" id="photo" placeholder="Enter le photo de Produite..." /><br><br>
            </div>
        </div>
        <br>
        <div class="form-group">
            <label class="label" for="Adresse">Adresse : </label><br>
            <input type="text" name="Adresse" class="input form-control" style="min-height:50px;" id="Adresse" placeholder="Enter Adresse .">
        </div>
        <br>
        ...
        <div class="d-flex w-100">
            ...
            <div class="form-group" style="width:48%;">
                ...
                <input type="number" name="telephone" class="input form-control" id="telephone" placeholder="Enter telephone .">
            </div>
        ...
        <br>
        <button type="submit" name="snd" class="button btn btn-outline-warning">Insert</button>
    </form>
</div>
@endsection