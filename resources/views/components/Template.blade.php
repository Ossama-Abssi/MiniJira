...
<head>
  ...
  <link rel="icon" href="url{{('photos/abl.png')}}"   type="image/x-icon">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3">
                        ...
                        <small class="mb-0 dropdown-user-designation text-secondary">chef de projet</small>
                      </div>
                    </div>
                  </a>
                </li>
                ...
                <div class="header-notifications-list p-2">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3 flex-grow-1">
                        <h6 class="mb-0 dropdown-msg-user">4 dashporedn Up <span class="msg-time float-end text-secondary">2 w</span></h6>
      ...
      <ul class="metismenu" id="menu">
        ...
        <li>
          <a href="{{url('phase')}}">
            ...
            <div class="menu-title">Phases</div>
          </a>
        ...
        <li>
          <a href="{{url('tim')}}">
            ...
            <div class="menu-title">Equeps</div>
          </a>
    ...
    <main class="page-content">
        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb ">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">@yield('namePage')</li>
            </ol>
          </nav>
        </div>
        <div class="ms-auto">
      ...
      <footer class="text-center text-white" style="background-color: #21081a;">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
          © 2023 Copyright:
          <a class="text-white" href="https://mdbootstrap.com/">ABL.site/officiel.com</a>
        </div>
        <!-- Copyright -->
      </footer>
      @yield('script')
