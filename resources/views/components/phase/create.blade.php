...
<div class="card-table">
  ...
  <form action="{{route('phase.store')}}" method="post">
    ...
    <div class="form-grouptext-center">
      ...
      <input type="text" name="Libellé" class="input form-control w-100" id="Libellé" placeholder="Enter Libellé .">
    </div>
    <br>
    <div class="form-group">
      <label class="label" for="Description">Description : </label><br>
      <input type="text" name="Description" class="input form-control" style="min-height:100px;" id="Description" placeholder="Enter Description .">
    </div>
    <br>
    <div class="d-flex w-100">
      <div class="form-group " style="width:48%;">
        <label class="label" for="DateDebut">Date Debut : </label><br>
        <input type="date" name="DateDebut" class="input form-control w-100" id="DateDebut" placeholder="Enter DateDebut .">
      </div>
      <div class="form-group " style="width:48%;margin-left:4%">
        <label class="label" for="DateFin">Date Fin : </label><br>
        <input type="date" name="DateFin" class="input form-control w-100" id="DateFin" placeholder="Enter DateFin .">
      </div>
    </div>
    <br>
    <div class="form-group">
      <label class="label" for="EtatDeRealisation">Etat De Realisation : </label><br>
      <select class="input form-select" aria-label="Default select example" name="EtatDeRealisation">
    ...
    <div class="d-flex w-100">
      ...
      <div class="form-group" style="width:48%;">
        ...
        <select class="input form-select" aria-label="Default select example" name="MontantAPayé">
          <option value="1">Termine</option>
          <option selected value="0">En cours</option>
        </select>
      </div>
      ...
      <div class="form-group" style="width:48%;margin-left:4%">
        ...
        <select class="input form-select" aria-label="Default select example" name="EtatDePaiement">
          <option value="1">Termine</option>
          <option selected value="0">En cours</option>
        </select>
      </div>
    ...
    <div class="form-group">
      ...
      <select class="input form-select" aria-label="Default select example" name="EtatDeFacture">
        <option value="1">Termine</option>
        <option selected value="0">En cours</option>
      </select>
    </div>
    ...
    <div class="form-group">
      ...
      <select class="input form-select" aria-label="Default select example" name="projet_id">
